...
<?php  $this->load->view('front/layout/header'); ?>
 <link rel="stylesheet" href="<?php base_url(); ?>assets/front/css/stylevendor.css"> 
 <link rel="stylesheet" href="<?php echo base_url() ?>assets/front/css/common.css">
<!-- Background image -->

<section class="service_banner banner-secion-common" id="service_banner" style="background-image: url('<?php base_url(); ?>assets/front/image/wed.jpg' )">
     <div class="banner-section-heading">
        <h1> CHOOSE CATEGORIES!</h1>
    </div>
</section>
<!--<div class="p-5 text-center bg-image banner-section-heading banner-secion-common" style="background-image: url('<?php base_url(); ?>assets/front/image/wed.jpg');">
    <div class="banner-section-heading">
        <h1> CHOOSE CATEGORIES!</h1>
    </div>
</div>-->
...
<div class="container">
    ...
    <div class="head">
        ...
        <img src="<?php base_url(); ?>assets/front/image/under.png" class="under" >
    </div>
    <div class="head">
...
<div class="container mt-4">
    <div class="row">
        ...
        <label>
          ...
          <input type="radio"  value="12345" name="product" class="panel card-input-element form-check radio " checked />
    ...
    <br>
      ...
      <img src="<?php base_url(); ?>assets/front/image/log.png" alt="img" class="logo">
