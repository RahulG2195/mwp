...
function Vendor_card($type, $cat_name, $seo_url, $image, $vendor_name, $rating, $review, $price_range, $area, $city, $tag)
{
  ...
  $output = '<div class="col-12 col-md-6 col-lg-4 vendor-col my-2">
                <span class="vendor-tag"><i class="fas fa-heart"></i> '. $tag .'</span>
...
function Vendor_card_without_col($type, $cat_name, $seo_url, $image, $vendor_name, $rating, $review, $price_range, $area, $city, $tag)
{
