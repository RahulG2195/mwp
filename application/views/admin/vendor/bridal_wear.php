              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <?php echo '<a href="'.base_url() . 'Single_data/bw/'.$row['dv_id'].'"><button class="btn btn-primary">View & Edit</button></a>' ?> 
                    <!--</br>-->&nbsp;&nbsp;&nbsp;
                        <?php echo '<a href="'.base_url() . 'Single_data_deals/'.$row['dv_id'].'"><button class="btn btn-primary">Deals & Coupon</button></a>' ?>
                    </td>
                    <!--<td><?php //echo '<a href="'.base_url() . 'Single_data_deals/bw/'.$row['dv_id'].'"><button class="btn btn-primary">Deals & Coupon</button></a>' ?> </td>-->
                    <td><?php
