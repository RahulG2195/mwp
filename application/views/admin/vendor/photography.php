        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="photography_table" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>Sr No</th>
                    <th>Name</th>
                  ...
                  <tr>
                    ...
                    <td>
                        <?php echo '<a href="'.base_url() . 'Single_data/ph/'.$row['dv_id'].'"><button class="btn btn-primary">View & Edit</button></a>' ?> 
                        &nbsp;&nbsp;&nbsp;
...
<script>
     $("#photography_table").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"],
      "order": [[0, 'desc']]
    }).buttons().container().appendTo('#photography_table_wrapper .col-md-6:eq(0)');
</script>