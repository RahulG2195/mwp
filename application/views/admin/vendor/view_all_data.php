...
<div class="content-wrapper">
    ...
    <section class="vendor_form_section common_section">
        <div class="container" id="form_cont">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url() . 'admin/Admin_Vendor/Insert_Data' ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card px-3 py-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" id="user_name" placeholder="User Name" name="user_name" value="<?php echo isset($user_name) ? $user_name : '' ?>">
                                </div>
                                <div class="col-md-6 form-group">
                        ...
                        <div class="card my-2 px-3 py-2">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="main_category" class="form-control cat_dropdown" id="category">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="vendor_tag" class="form-label vendor-form-label">Vendor Tag</label>
                                    <input type="hidden" name="default_vendor_tag" id="selected_vendor_tag" value="<?php echo isset($vendor_tag) ? $vendor_tag : '' ?>">

                                    <select name="main_vendor_tag" class="form-control vendor_tag_dropdown" id="vendor_tag">
