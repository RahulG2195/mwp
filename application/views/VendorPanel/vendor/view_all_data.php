...
<div class="content-wrapper">
    ...
    foreach ($vendor_data as $val) {
        ...
        $vendor_tag = !empty($val['tag_id']) ? $val['tag_id'] : 'N/A';
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url() . 'VendorPanel/Admin_Vendor/Insert_Data' ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="vendor_count" id="vendor_count_hd" value="<?php echo isset($dv_id) ? $dv_id : '' ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label for="text" class="form-label vendor-form-label">Vendor Name<span class="text text-danger p-0">*</span></label>
                                        <input type="text" class="form-control" id="vendor_name" placeholder="Your Business name" name="vendor_name" value="<?php echo isset($vendor_name) ? $vendor_name : '' ?>" readonly>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="vendor_email" class="form-label vendor-form-label">Email<span class="text text-danger p-0">*</span></label>
                                    <input type="email" class="form-control" id="vendor_email" placeholder="Profession Email" name="vendor_email" value="<?php echo isset($vendor_email) ? $vendor_email : '' ?>" readonly>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="city" class="form-control" id="city" readonly disabled>
                        ...
                        <div class="card my-2 px-3 py-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="main_vendor_tag" class="form-control vendor_tag_dropdown" id="vendor_tag" disabled readonly>
                        ...
                        <div class="card my-2 px-3 py-2">
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <div class="col-md-3 my-3 imagelocation<?php echo $i; ?>">
                                                <img src="<?php echo base_url(); ?>uploads/vendors/<?php echo $img; ?>" style="vertical-align:middle;" width="80" height="80">
                            ...
                            <div class="card my-2 px-3 py-2">
                                ...
                                <div class="row">
                                    ...
                                    $img = $vendor_data[0]['comp_logo'];
                                        ?>
                                            <div class="col-md-12 my-3 logolocation0">
                                                <img src="<?php echo base_url(); ?>uploads/comp-logo/<?php echo $img; ?>" style="vertical-align:middle;" width="80" height="80">
                                                    <!-- <span style="cursor:pointer;" onclick="javascript:deleteimage(<?php echo ''; ?>)">X</span> -->
                                                    <div class="day_div">
                        ...
                        <div class="col-12 text-center my-md-4 my-2">
                            ...
                            <?php }else { ?>
                                <button class="btn vendor-btn-submit  btn-success" id="request_to_edit" type="button">Request to Edit</button>    
                            <?php } ?>
                        </div>
                    </form>
                </div>
...
<script>
    const request_to_edit = document.querySelector('#request_to_edit');
    const edit_btn = document.querySelector('#edit_btn');
    const update_enable = document.querySelector('.update_enable');
    const close_btn = document.querySelector('#close_btn');
    const city = document.querySelector('#city');    
    const category = document.querySelector('#category');
    const vendor_tag = document.querySelector('#vendor_tag');    
    ...
    if(!!request_to_edit){
        request_to_edit.addEventListener('click', function() {
            var vendor_countv = document.getElementById('vendor_count_hd').value;
            console.log('request_to_edit '+vendor_countv);
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('VendorPanel/Admin_Vendor/request_to_edit');?>",
                data: {vendor_count:vendor_countv},
                success: function (response) {
                  if (response == 1) {
                    confirm ("Edit Request send to Admin");
                  };              
                }
            });
        })
