...
//                                echo "sdsd ".DATETIME;
          ...
          <a style="pointer-events: none;" href="void(0)" class="box d-flex flex-column align-items-center justify-content-center">
                                            <div style="margin-top:0px;"><h4><?php echo $img['title'].' | '.$img['coupon_code'].' | '.$img['discount_value']; ?></h4></div>
          ...
          <!--<div class="carousel-item">-->
            ...
            <!--<img src="<?php echo base_url() ?>assets/front/image/home-icon/MWP-BRIDAL-JEWELLERY-PINK.png" alt="image" class="hover">-->
                                             ...
                                             <div style="margin-top:-35px;"><h4><?php echo $img['custom_text']; ?></h4></div>
        </a>
<!--//                                        echo '<div class="carousel-item ' . ($i == 1 ? 'active' : '') . '">-->
