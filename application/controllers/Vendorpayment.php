...
class Vendorpayment extends CI_Controller {
    ...
    public function emailvendor($paymentdatabasic) {
        if (strtolower($paymentdatabasic["plan_name"]) == "Palette Pro") {
            $message = $this->load->view("front/email/email-template-palette-pro", $paymentdatabasic, TRUE); //vendor success
    ...
    public function emailvendorfree($paymentdatabasic) {
        $config = array('protocol' => 'smtp',
            'smtp_host' => 'smtp.gmail.com',
            'smtp_port' => 587,
            'smtp_user' => 'mwp@myweddingpalette.com',
