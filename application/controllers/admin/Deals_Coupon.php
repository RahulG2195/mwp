...
class Admin_Vendor extends CI_Controller {
    ...
    function Vendor_all_Data($tab, $id) {
        ...
        $data['allcity'] = $this->VendorModel->fetch_vendor_city();
        $data['allcategory'] = $this->VendorModel->fetch_vendor_categories();
        $data['alltag'] = $this->VendorModel->fetch_vendor_tags();
        // echo "<pre>";
        // print_r($data);
        // exit;
        ...
        function Insert_Data()
    {
        if ($this->input->post()) {
           pr($this->input->post(), '');exit;
            ...
            $data = $this->VendorPanelModel->GetDataVin(array('dv_id'=>$vid));
        ...
        echo '<script>alert("Data has been updated!"); window.location.href = "'.base_url().'admin/Admindashboard/"</script>';
    }
}
